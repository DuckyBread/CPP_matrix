# CPP_matrix
This project contains C++ library which allows to create and work with matrices.

## Matrix operations

There is a brief description of the matrix operations below that need to be implemented in the developing library. Project is made in _*custom*_ namespace.
